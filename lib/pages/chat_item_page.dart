...
import 'package:chatz/models/chat_item_model.dart';
    ...
    return Container(
      ...
      child: Row(
        children: <Widget>[
          ...
          IconButton(
            icon: Icon(Icons.attach_file, color: AppColors.blueColor),
            onPressed: () {},
          ),
          IconButton(
            icon: Icon(Icons.alternate_email, color: AppColors.blueColor),
            onPressed: () {},
          ),
        ],
      ),
